...
\dia{29}
\mes{2}
\ano{2014} % Indicar apenas o ano da monografia
...
% ---
\orientador{Nome Completo Orientador}
\orientadorTitulacao{Doutor em Ciência da Computação}
\orientadorDepartamento{DECSI - UFOP}

\coorientador{Nome Completo Coorientador}
\coorientadorTitulacao{Doutor em Ciência da Informação}
...
%\convidadoTres{Prof. Me. Nome Completo Convidado3}
%\convidadoTresTitulacao{Doutor em Engenharia Elétrica}
%\convidadoTresDepartamento{DEELT - UFOP}
